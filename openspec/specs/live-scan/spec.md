# live-scan Specification

## Purpose
Defines on-demand result generation: scanning a repository in-process with the
Scorecard library and formatting canonical JSON2, with auxiliary clients created
once and reused, SCM token and per-host rate management, explicit
skip-versus-failure handling, and declared check coverage.
## Requirements
